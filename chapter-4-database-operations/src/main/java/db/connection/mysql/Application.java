...
public class Application {
	...
	private static void runPresentationLayer(EmployeeService employeeService, SalaryService salaryService,
			ManagerService managerService, DepartmentService departmentService) {
    ...
    public static void showDepartment(DepartmentService departmentService) {
